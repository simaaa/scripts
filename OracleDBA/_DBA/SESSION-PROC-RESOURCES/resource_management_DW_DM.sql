...
select t.* from dba_rsrc_consumer_groups t where t.internal_use != 'YES' /*and t.consumer_group like 'DW%'*/ order by t.consumer_group;
...
select t.* from dba_rsrc_plans t /*where t.plan like 'DW_LOAD%'*/ order by t.num_plan_directives;
