SELECT
  DECODE(px.qcinst_id, NULL, username, ' - ' || LOWER(SUBSTR(pp.SERVER_NAME,LENGTH(pp.SERVER_NAME)-4,4)) ) AS "Username",
...
WHERE 1=1
--AND DECODE(px.qcinst_id, NULL, TO_CHAR(s.SID), px.qcsid) = 46
